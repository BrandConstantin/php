            ...
            <div class="row col s12 m12 l12 xl12">
                ...
                <?php
                    if( ($_POST['action'] == 'removed')){
                        $deleted = "delete from $tableProducts where prodId = '".$_POST[prodId]."'";                           

                        $connection->exec($deleted);

                        //echo $deleted;
                        echo '<h1>Producto eliminado correctamente!<META HTTP-EQUIV = "Refresh" Content = "5; URL = index.php"></h1>';
                    }else{
                        echo '<h1>El producto no ha podido ser eliminado!<META HTTP-EQUIV = "Refresh" Content = "5; URL = index.php"></h1>';
                    }
                ?>
                </div>
            </div>
