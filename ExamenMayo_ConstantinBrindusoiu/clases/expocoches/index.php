...
<html>
    ...
    <body>
        ...
        // Ejecutamos la funcion de modificar Datos
        funcModificDatos();
        ?>
        ...
        <form action="index.php" method="post">
            ...
            Nombre: <input type="text" name="nombreNuevo" required>
            Plazas: <input type="number" min="1" placeholder="100" name="plazasNombreNuevo" required>
            Plazas Ocupadas: <input type="number" min="1" placeholder="100" name="plazasOcupadasNombreNuevo" required><br>
            <input type="submit" name="modificar" value="Modificar Zona">
        </form>
    </body>
</html>
...
//función de modificar zona
function funcModificDatos(){
    //si se ha pulsado el botos de modificar
    if(isset($_POST['modificar'])){
        // Creamos el nuevo objeto zona
        unset($_SESSION["zona"][$_POST["zona"]]);
        $zona = new Zona($_POST["nombreNuevo"], $_POST["plazasNombreNuevo"], $_POST['plazasOcupadasNombreNuevo']);
        
        // Serializamos y guardamos en Session
        $_SESSION["zona"][$_POST["nombreNuevo"]] = serialize($zona);
        
        // Imprimimos por pantalla que ha sido un exito
        echo '<p class="especial">Zona Modificada con Exito</p>';
    }
}
