  ...
  <body>
    ...
    <!--------------------------------------------------------->    
            ...
            <div id="login" class="col-xs-12 col-sm-12 col-md-12">
              <h1 style="margin-bottom: 50px;">Modifica Datos:</h1>
              <form action="modifyPubAction.php" method="POST">
                ...
                <input type="texto" name="pubLogo" class="form-control center-block" id="pubLogo" value="<?= $pubLogo; ?>"></br>
                
                <span class="glyphicon glyphicon-user"></span>
                <label for="pubName">Nombre:</label><br>
                <input type="text" name="pubName" class="form-control center-block" id="pubName"  value="<?= $pubName; ?>"></br>
                
                <span class="glyphicon glyphicon-user"></span>
                <label for="pubPass">Contraseña:</label><br>
                <input type="text" name="pubPass" class="form-control center-block" value="<?= $pubPass; ?>"></br>
                
                <span class="glyphicon glyphicon-user"></span>
                <label for="pubEmail">Correo:</label><br>
                <input type="text" name="pubEmail" class="form-control center-block" id="pubEmail"  value="<?= $pubEmail; ?>"></br>
                
                <span class="glyphicon glyphicon-user"></span>
                <label for="pubUbication">Ubicación:</label><br>
                <input type="text" name="pubUbication" class="form-control center-block" id="pubUbication" value="<?= $pubUbication; ?>"></br>
                
                <span class="glyphicon glyphicon-user"></span>
                <label for="city">Ciudad:</label><br>
                <input type="text" name="city" class="form-control center-block" id="city" value="<?= $city; ?>"></br>
                                
                <span class="glyphicon glyphicon-user"></span>
                <label for="dateHigh">Fecha Alta:</label><br>
                <input type="date" name="dateHigh" class="form-control center-block" id="dateHigh" value="<?= $dateHigh; ?>"></br>
                
                <span class="glyphicon glyphicon-user"></span>
                <label for="capacity">Capacidad:</label><br>
                <input type="number" name="capacity" class="form-control center-block" id="capacity"  value="<?= $capacity; ?>"></br>
                
                <span class="glyphicon glyphicon-user"></span>
                <label for="musicType">Tipo Musica:</label><br>
                <input type="text" name="musicaType" class="form-control center-block" id="musicType" value="<?= $musicType; ?>"></br>
                
                <span class="glyphicon glyphicon-user"></span>
                <label for="pubDj">Dj:</label><br>
                <input type="text" name="pubDj" class="form-control center-block" id="pubDj"  value="<?= $pubDj; ?>"></br>
                ...
                <button type="submit" class="btn btn-default" name="action" value="modify" style="background-color: #lightblue;">Modificar
