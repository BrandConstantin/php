            ...
            <div class="row col s12 m12 l12 xl12">
                ...
                <h1>Registrate</h1>
                    <div class="col s10 m10 l10 xl10">
                      <form class="col s12 m12 l12 xl12 " method="post" action="registerOk.php">
                        <div class="row">
                          ...
                          <div class="input-field col s6">
                              ...
                              <input name="cargo" type="hidden">
                            <label for="last_name">Contraseña</label>
                          </div>
                        </div>
                        <button type="submit" class="btn-floating btn-small waves-effect waves-light green right" value="registerOk"><i class="material-icons">done</i></button>
                      </form>
                    </div>
            </div>
