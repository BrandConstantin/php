    ...
    <body>
        <div class="container blue lighten-3">
            ...
            <div class="row col s12 m12 l12 xl12">
                ...
                <?php
                    if( ($_POST['action'] == 'decreated')){
                        $decrease = ( $_POST[stock] - $_POST[stockDecrease] );
                        
                        $decreated = "update $tableProducts set stock = \"$decrease\" where prodId = '".$_POST[prodId]."'";                           

                        $connection->exec($decreated);

                        //echo $increased;
                        echo '<h1>Stock decrementado correctamente!<META HTTP-EQUIV = "Refresh" Content = "5; URL = index.php"></h1>';
                    }else{
                        echo '<h1>El stock no ha podido ser decrementado!<META HTTP-EQUIV = "Refresh" Content = "5; URL = index.php"></h1>';
                    }
                ?>
                </div>
            </div>
