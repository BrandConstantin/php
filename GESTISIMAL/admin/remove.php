            ...
            <div class="row col s12 m12 l12 xl12">
                ...
                <div class="col s7 m8 l10 xl10 blue lighten-5">
                    <table class="highlight blue lighten-3 responsive-table">
                        <thead>
                            <tr>
                                <th><strong style="color:#e57373; font-size: 1.7em;">Borrar Producto</strong></th>
                            </tr>                            
                            <tr>
                                <td colspan="10">                                    
                                    <form action="removed.php" method="post">
                                        <h5>Estas absolutamente seguro de que quieras eliminar el producto con las siguientes carácteristicas:</h5>
                                        ...
                                        <input type="text" class="validate" name="prodDesc" readonly="" value="<?= $prodDesc ?>"/>
                                        <label for="prodBuy">Precio-Compra Producto</label>
                                        <input type="number" class="validate" name="prodBuy" readonly="" value="<?= $prodBuy ?>"/>
                                        <label for="prodSell">Precio-Venta Producto</label>
                                        <input type="number" class="validate" name="prodSell" readonly="" value="<?= $prodSell ?>"/>
                                    ...
                                    <tr>
                                        <td>
                                            <button type="submit" class="btn-floating btn-small waves-effect waves-light green" value="Removed">SI</button>
                                        </form>
                                        </td>
                                        <td>
                                            <a class="waves-effect red lighten-2 btn" href="index.php">NO</a>                                    
                                        </td>
                                    </tr>
                        </tbody>
                    </table>                 
