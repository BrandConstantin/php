            ...
            <div class="row col s12 m12 l12 xl12">
                ...
                <div class="col s12 m12 l12 xl12 blue lighten-5">
                    <table class="highlight blue lighten-3 responsive-table">
                        <thead>
                            <tr>
                                <th><strong style="color:#e57373; font-size: 1.7em;">Incrementar Producto</strong></th>
                            </tr>                            
                            <tr>
                                <td colspan="10">                                    
                                    <form action="increased.php" method="post">                                        
                                        ...
                                        <input type="number" class="validate" name="stockIncrease" value="<?= $stockIncrease ?>" autofocus=""/>
                                        <input type="hidden" name="action" value="increased"/>    
                                    </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <button type="submit" class="waves-effect lighten-2 btn green" value="Increased">Incrementar</button>
                                        </form>
                                        </td>
                                        <td>
