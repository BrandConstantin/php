            ...
            <div class="row col s12 m12 l12 xl12">
                ...
                <div class="col s12 m12 l12 xl12 blue lighten-5">
                    <table class="highlight blue lighten-3 responsive-table">
                        <thead>
                            <tr>
                                <th><strong style="color:#e57373; font-size: 1.7em;">Modificar Producto</strong></th>
                            </tr>                            
                            <tr>
                                <td>                                    
                                    <form action="modified.php" method="post">
                                        ...
                                        <input type="text" class="validate" name="prodName" value="<?= $prodName ?>"/>
                                        <label for="prodDesc">Descripción Producto</label>
                                        <input type="text" class="validate" name="prodDesc" value="<?= $prodDesc ?>"/>
                                        <label for="prodBuy">Precio-Compra Producto</label>
                                        <input type="number" class="validate" name="prodBuy" value="<?= $prodBuy ?>"/>
                                        <label for="prodSell">Precio-Venta Producto</label>
                                        <input type="number" class="validate" name="prodSell" value="<?= $prodSell ?>"/>
                                        <label for="stock">Total Productos (Stock)</label>
                                        <input type="number" class="validate" name="stock" value="<?= $stock ?>" />
                                        <input type="hidden" name="action" value="modified"/>                                                                                
                                </td>
                            </tr>
                            <tr>
                                <td>
                                        <button type="submit" class="btn-floating btn-small waves-effect waves-light green" value="Modified"><i class="material-icons">send</i></button>
                                    </form>
                                </td>
                                <td>
