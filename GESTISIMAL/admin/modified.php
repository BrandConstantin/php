    ...
    <body>
        <div class="container blue lighten-3">
            ...
            <div class="row col s12 m12 l12 xl12">
                ...
                <?php
                    if( ($_POST['action'] == 'modified')){
                        $modified = "update $tableProducts set "
                                . "prodId = \"$_POST[prodId]\", prodName = \"$_POST[prodName]\", prodDesc = \"$_POST[prodDesc]\", "
                                . "prodBuy = \"$_POST[prodBuy]\", prodSell = \"$_POST[prodSell]\", stock = \"$_POST[stock]\""
                                . " where prodId = '".$_POST[prodId]."'";                           

                        $connection->exec($modified);

                        //echo $modified;
                        echo '<h1>Producto modificado correctamente!<META HTTP-EQUIV = "Refresh" Content = "5; URL = index.php"></h1>';
                    }else{
                        echo '<h1>El producto no ha podido ser modificado!<META HTTP-EQUIV = "Refresh" Content = "5; URL = index.php"></h1>';
                    }
                ?>
                </div>
            </div>
